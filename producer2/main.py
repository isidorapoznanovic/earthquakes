...
MAX_ENTRIES = 50
KAFKA_TOPIC = environ.get("KAFKA_TOPIC", "earthquakes-topic2")

KAFKA_CONFIGURATION = {
    "bootstrap_servers": environ.get("KAFKA_BROKER", "kafka2:19093").split(","),
